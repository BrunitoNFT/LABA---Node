...
function calculateDiscountedPrice(products, discountPercentage) {
    ...
    for (const product of products) {
        ...
        discountedProducts.push(Object.assign(Object.assign({}, product), { price: discountedPrice }));
    }
...
function getAverageGrade(students) {
    const getGrades = (students) => students.flatMap(student => student.grades);
    const calculateAverage = (grades) => grades.reduce((acc, grade) => acc + grade, 0) / grades.length;
